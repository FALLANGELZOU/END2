...
class Trainer(ABC):
    ...
    def main_worker(self, rank, args: Any):
        ...
        args["start_epoch"] = args["start_epoch"] if args["start_epoch"] is not None else 0
        args['logger'] = logger
        ...
        if args["ckpt_path"] is not None:
            ...
            checkpoint = torch.load(args["ckpt_path"], map_location=loc)
        ...
        if args['infer']:
            ...
            for epoch in range(args['start_epoch'], args['max_epoch']):
                ...
                self.adjust_learning_rate(optimizer, args)
